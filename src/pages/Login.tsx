...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: any): Promise<void> => {
    ...
    try {
      ...
      // Store token in localStorage (use access_token from response)
      localStorage.setItem("token", response.access_token);
        ...
        >
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Continue your journey with AI-powered sales automation that never
              sleeps.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white border border-emerald-500/20 rounded-3xl p-8 shadow-2xl shadow-emerald-500/10 backdrop-blur-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="group mb-2 relative w-full px-8 py-4 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-bold text-lg rounded-xl overflow-hidden hover:shadow-2xl hover:shadow-emerald-500/50 transition-all duration-300 mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  {isLoading ? (
                    <>
